...
public class Waypoints {
     ...
     * Lattitude * 10**7 public double lng; // Longitude * 10**7 public float
     * alt; // Altitude in centimeters (meters * 100) }
     * 
     * By default ID = 16 or MAV_CMD.WAYPOINT (for waypoint). Lat, lng, alt used
     * by location object. p1-p4 and options are unused so far. If they will be
     * needed, the location object have to get extended by this parameters.
     * 
     */
    ...
    public String toString() {
        ...
        for (int i = 0; i < list.length; i++) {
            jsonString.append("{\"alt\":").append(list[i].getAlt() + ",").append("\"id\":")
                    .append(MAV_CMD.WAYPOINT.getValue() + ",").append("\"lat\":")
                    .append(list[i].getLat() + ",").append("\"lng\":")
                    .append(list[i].getLng() + ",").append("\"options\":").append("1,")
                    .append("\"p1\":").append("0,").append("\"p2\":").append("0,")
                    .append("\"p3\":").append("0,").append("\"p4\":").append("0}");
